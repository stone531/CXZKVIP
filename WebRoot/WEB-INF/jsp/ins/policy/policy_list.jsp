						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">投保人手机号</th>
									<th class="center">被保险人姓名</th>
									<th class="center">被保险人证件号码</th>
									<th class="center">被保险人职业</th>
									<th class="center">与被保险人关系</th>
									<th class="center">被保险人年龄</th>
									<th class="center">受益人姓名</th>
									<th class="center">受益人证件号码</th>
									<th class="center">服务人员姓名</th>
									<th class="center">服务人员手机号码</th>
									<th class="center">是否发生短信</th>
									<th class="center">是否已经生成保单号</th>
									<th class="center">投保时间</th>
									<th class="center">保单生效时间</th>
									<th class="center">保单时效时间</th>
							...
							<c:choose>
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											<td class='center'>
												<label class="pos-rel"><input type='checkbox' name='ids' value="${var.POLICY_ID}" class="ace" /><span class="lbl"></span></label>
											</td>
											...
											<td class='center'>${var.IERPHONE}</td>
											<td class='center'>${var.IANTNAME}</td>
											<td class='center'>${var.IANTPAPERNO}</td>
											<td class='center'>${var.IANTPROFESSION}</td>
											<td class='center'>${var.IANTRELATION}</td>
											<td class='center'>${var.IANAGE}</td>
											<td class='center'>${var.BENNAME}</td>
											<td class='center'>${var.BENPAPERNO}</td>
											<td class='center'>${var.SVRNAME}</td>
											<td class='center'>${var.SVRPHONE}</td>
											<td class='center'>${var.ISSENDMESSAGE}</td>
											<td class='center'>${var.ISHASPOLICYNO}</td>
											<td class='center'>${var.CREATED}</td>
											<td class='center'>${var.UPDATED}</td>
											<td class='center'>${var.INVALID}</td>
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<c:if test="${QX.edit == 1 }">
													<a class="btn btn-xs btn-success" title="编辑" onclick="edit('${var.POLICY_ID}');">
														<i class="ace-icon fa fa-pencil-square-o bigger-120" title="编辑"></i>
													</a>
													</c:if>
													<c:if test="${QX.del == 1 }">
													<a class="btn btn-xs btn-danger" onclick="del('${var.POLICY_ID}');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<c:if test="${QX.edit == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="edit('${var.POLICY_ID}');" class="tooltip-success" data-rel="tooltip" title="修改">
																	<span class="green">
															...
															<c:if test="${QX.del == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="del('${var.POLICY_ID}');" class="tooltip-error" data-rel="tooltip" title="删除">
																	<span class="red">
