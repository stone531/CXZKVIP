						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">缴款日期</th>
									<th class="center">缴款金额</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.OFA_DATE}</td>
											<td class='center'>${var.OFA_CODE}</td>
											<td class='center'>${var.OFT_TYPE_ID}</td>
											<td class='center'>${var.OFA_CUSTOMER_ID}</td>
											<td class='center'>${var.ITEM_PRICE}</td>
											<td class='center'>${var.OFA_QUANTITY}</td>
											<td class='center'>${var.OFA_SUM_AMOUNT}</td>
											<td class='center'>${var.REAL_DATE}</td>
											<td class='center'>${var.OFA_AMOUNT}</td>
											<td class='center'>${var.OFA_USE_PERIOD}</td>
