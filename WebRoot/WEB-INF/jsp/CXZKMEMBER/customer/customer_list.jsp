...
<body class="no-skin">
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.CUS_TYPE}</td>
											<td class='center'>${var.CUS_COMPANY}</td>
											<td class='center'>${var.CUS_DUTY_name}</td>
											<td class='center'>${var.CUS_SEX}</td>
											<td class='center'>${var.CUS_BUSINESS_ADDRESS}</td>
											<td class='center'>${var.CUS_MOBILE_TEL}</td>
											<td class='center'>${var.CUS_NOTE}</td>
											<td class='center'>${var.CREATION_DATE}</td>
											<td class='center'>${var.CREATED_BY}</td>
											<td class='center'>${var.EDUCATION_ID_name}</td>
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<a class="btn btn-xs btn-success" title="查看" onclick="goDetail('${var.CUSTOMER_ID}');">
	...
	<script type="text/javascript">
		...
		function goDetail(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="查看";
			 diag.URL = '<%=basePath%>customer/goDetail.do?CUSTOMER_ID='+Id;
			 diag.Width = 800;
			 diag.Height = 600;
			 diag.CancelEvent = function(){ //关闭事件
				 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
