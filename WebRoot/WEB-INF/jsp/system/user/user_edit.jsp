		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post" AUTOCOMPLETE="OFF">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">用户编码:</td>
										...
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">用户密码:</td>
										...
										<tr>
											...
											<td>
												<input name="SEX" type="radio" class="ace"id="sexM" value="MAN" checked="checked" > <span class="lbl">男</span>&nbsp;&nbsp;&nbsp;&nbsp;
												<input name="SEX" type="radio" class="ace"id="sexW" value="WOMAN" <c:if test="${'WOMAN' == pd.SEX }">checked="checked"</c:if> > <span class="lbl">女</span>
											</td>
										</tr>
										...
										<tr>
											...
											<td id="gongsi">
											<select class="chosen-select form-control" name="DEPARTMENT_ID" id="DEPARTMENT_ID" onchange="show_Dep($(this).val())" data-placeholder="请选择公司" style="vertical-align:top;" style="width:98%;" >
											<option value=""></option>
											<c:forEach items="${depList}" var="dep">
												<option value="${dep.DEPARTMENT_ID }" <c:if test="${dep.DEPARTMENT_ID == pd.DEPARTMENT_ID }">selected</c:if>>${dep.NAME }</option>
											</c:forEach>
											</select>
											</td>
										</tr>
										<tr>
											...
											<td id="bumen">
											<select class="chosen-select form-control" name="BIANMA" id="BIANMA" data-placeholder="请选择部门" style="vertical-align:top;" style="width:98%;" >
											<option value=""></option>
											<c:forEach items="${dicList}" var="dic">
												<option value="${dic.DICTIONARIES_ID }" <c:if test="${dic.DICTIONARIES_ID == pd.BIANMA }">selected</c:if>>${dic.NAME }</option>
											</c:forEach>
											</select>
											</td>
										</tr>
