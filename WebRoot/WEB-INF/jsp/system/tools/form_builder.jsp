...
<base href="<%=basePath%>">
	...
	<!-- 表单构建组建 -->
	<link rel="shortcut icon" href="favicon.ico"> <link href="plugins/hplus/css/bootstrap.min.css?v=3.3.5" rel="stylesheet">
    <link href="plugins/hplus/css/animate.min.css" rel="stylesheet">
    <link href="plugins/hplus/css/style.min.css?v=4.0.0" rel="stylesheet"><base target="_blank">
	<!-- 日期框 -->
...
<body class="gray-bg">
	...
	<!-- 表单构建组建 -->
    <script src="plugins/hplus/js/bootstrap.min.js?v=3.3.5"></script>
    <script src="plugins/hplus/js/content.min.js?v=1.0.0"></script>
    <script src="plugins/hplus/js/jquery-ui-1.10.4.min.js"></script>
    <script src="plugins/hplus/js/beautifyhtml/beautifyhtml.js"></script>
	<!-- 百度富文本编辑框-->
