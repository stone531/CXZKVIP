  	...
  	<div class="commitbox">
	  	<div class="commitbox_inner">
	        <div class="commitbox_top">
	        	<textarea name="EMAILs" id="EMAILs" placeholder="请选输入对方手机号,多个请用(;)分号隔开" title="请选输入对方手机号,多个请用(;)分号隔开"></textarea>
								...
								<table style="width:100%;" id="xtable">
									<tr>
										<td style="margin-top:0px;">
											 <div style="float: left;width:88%"><textarea name="phones" id="phones" rows="1" cols="50" style="width:100%;height:35px;" placeholder="请选输入对方手机号,多个请用(;)分号隔开" title="请选输入对方手机号,多个请用(;)分号隔开"></textarea></div>
...
$(function(){if('tool'== locat[3]){locat =  locat[0]+'//'+locat[2];}else{locat =  locat[0]+'//'+locat[2]+'/'+locat[3];};});
	...
	function sendEm(){
		...
		$.ajax({
			type: "POST",
			url: 'tool/SendMessages.do',
	    	data: {phones:$("#phones").val(),MESSAGE:$("#MESSAGE").val()},
			dataType:'json',
