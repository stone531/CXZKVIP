...
INSERT INTO `sys_menu` VALUES ('51', '表单构建', 'tool/goFormbuilder.do', '9', '0', 'menu-icon fa fa-cogs brown', '1', '1');
INSERT INTO `sys_menu` VALUES ('52', '图片爬虫', 'pictures/goImageCrawler.do', '6', '1', 'menu-icon fa fa-folder-o pink', '2', '1');
-- ----------------------------
