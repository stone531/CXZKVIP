...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL+"../../news/upload"             //图片上传提交地址
        ,imagePath:URL + "../../uploadFiles/uploadImgs"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        //附件上传配置区
        ,fileUrl:URL+"../../news/upload"               //附件上传提交地址
        ,filePath:URL + "../../uploadFiles/uploadImgs"                   //附件修正地址，同imagePath
