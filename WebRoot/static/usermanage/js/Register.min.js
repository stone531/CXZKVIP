...
function existsTxtMobile() {
	if ($("#mobile-type").val()=="1"){
		return existsControlValue("txtMobile",RexistMobile,"您输入的手机尚未注册");
	}else{
...
function mobileRegister(){
    ...
    //    url: "/CXZKVIP/usermanage/register/do_register",
       // data: {MOBILE:$("#txtMobile").val(), PASSWORD:$("#txtMobilePassword").val(),USERTYPE:"0",smsCode":$("#txtSmsCode").val()},
        //dataType: "json",
