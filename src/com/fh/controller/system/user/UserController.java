...
public class UserController extends BaseController {
	...
	public ModelAndView saveU() throws Exception{
		...
		pd.put("SKIN", "default");
		pd.put("RIGHTS", "");		
		pd.put("NUMBER", pd.getString("USERNAME"));
	...
	public ModelAndView goEditU() throws Exception{
		...
		depPd.put("PARENT_ID", "1");
		page.setPd(depPd);
		List<PageData>	depList = departmentService.list(page);	//列出Dictionaries列表
		//列出部门列表
		depPd.put("DICTIONARIES_ID", "604d57bf56ca4590859838db79780b86");					//上级ID
		page.setPd(depPd);
		List<PageData>	dicList = dictionariesService.list(page);	//列出Dictionaries列表
		mv.setViewName("system/user/user_edit");
