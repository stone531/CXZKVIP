package com.fh.controller.ins.company;
...
public class CompanyController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("ins/company/company_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("ins/company/company_edit");
	...
	public void getworkjson(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		pd.put("COMPANY_ID", "21aeca2e15014a168b3d67b53f122c54");
		PageData respd = companyService.getworkjson(pd);
		
		out.write(respd.getString("WORKJSON"));
	}
