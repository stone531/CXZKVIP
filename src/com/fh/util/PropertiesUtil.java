 ...
 * 
 * @author YHS 新增日期：2015-08-27
 * @author YHS 修改日期：2015-08-27
...
public class PropertiesUtil {
	...
	public static void main(String[] args) {
		...
		String v = PropertiesUtil.getValue(path, "maxActive");
		logger.info("value0 = " + v);

		Hashtable<String, String> ht = new Hashtable<String, String>();
		ht.put("name", "dengcd");
		PropertiesUtil.setValueAndStore(path, ht);
		String v_ = PropertiesUtil.getValue(path, "maxWait");
		logger.info("value1 = " + v_);
		PropertiesUtil.reloadPropertyFile(path);
		String v2_ = PropertiesUtil.getValue(path, "minIdle");
