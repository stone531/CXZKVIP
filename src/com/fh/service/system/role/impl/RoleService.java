...
public class RoleService implements RoleManager{
	 ...
	 */
	@Override
	public void updateDepRoleRights(Role role) throws Exception {
		dao.update("RoleMapper.updateDepRoleRights", role);
	}
	 ...
	 */
	@Override
	public void setAllDEPRights(PageData pd) throws Exception {
		dao.update("RoleMapper.setAllDEPRights", pd);
	}
