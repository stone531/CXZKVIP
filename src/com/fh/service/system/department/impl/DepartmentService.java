...
public class DepartmentService implements DepartmentManager{
	...
	public PageData findMaxId(PageData pd) throws Exception {
		return (PageData) dao.findForObject("DepartmentMapper.findMaxId", pd);
	}
	 ...
	 */
	@Override
	public Department findDepById(String DEPARTMENT_ID) throws Exception {
		return (Department)dao.findForObject("DepartmentMapper.findDepById", DEPARTMENT_ID);
	}
